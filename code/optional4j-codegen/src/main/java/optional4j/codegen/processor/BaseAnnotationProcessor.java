...
public abstract class BaseAnnotationProcessor<A extends Annotation, E extends CtElement>
    ...
    private static final NullabilityValue DEFAULT_NULLITY = NON_NULL;
    ...
    private NullabilityValue getNullity() {
        return nullity == null ? DEFAULT_NULLITY : NullabilityValue.valueOf(nullity.toUpperCase());
    }
