...
public class NullableReturnTest {
    ...
    public void getCustomer() {
        ...
        // when
        Optional<Customer> b = order.getCustomer();

        // then
        assertThat(Customer.class.isAssignableFrom(b.getClass())).isFalse();
        assertThat(Optional.class.isAssignableFrom(b.getClass())).isTrue();
    }
